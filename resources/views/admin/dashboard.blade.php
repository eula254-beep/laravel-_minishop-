...
@section('title', 'Admin Dashboard - MiniShop')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-8 flex justify-between items-center">
        ...
        <a href="{{ route('admin.products.create') }}" class="bg-indigo-600 text-white px-6 py-3 rounded-md hover:bg-indigo-700 transition flex items-center">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div class="h-16 w-16 flex-shrink-0 bg-gray-100 rounded">
    ...
    @else
        <div class="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <h3 class="mt-4 text-xl font-medium text-gray-900">No products yet</h3>
            <p class="mt-2 text-gray-500">Get started by creating your first product.</p>
            <a href="{{ route('admin.products.create') }}" class="mt-6 inline-flex items-center bg-indigo-600 text-white px-6 py-3 rounded-md hover:bg-indigo-700 transition">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                </svg>
                Create Product
